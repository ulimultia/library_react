  ...
  submitNow = (e) => {
    ...
    if (this.state.btn === "Tambah") {
      ...
      if (isValid === true) {
        ...
        axios
          .post("http://localhost:8080/api/v1/lokasi/add", lokasiDto, {
            headers: userHeader,
          })
          .then((response) => {
            console.log(response);
    ...
    // untuk edit data
      ...
      if (isValid === true) {
        ...
        axios
          .put("http://localhost:8080/api/v1/lokasi/edit", lokasiDto, {
            headers: userHeader,
          })
          .then((response) => {
            console.log(response);
  ...
  handleDelete = (id) => {
    ...
    MySwal.fire({
      ...
      if (willDelete.isConfirmed) {
        axios
          .delete("http://localhost:8080/api/v1/lokasi/delete/" + id, {
            headers: userHeader,
          })
          .then((response) => {
            console.log(response);
                          ...
                          <ModalBody className="mx-4">
                            ...
                            <FormGroup>
                              ...
                              <Input
                                ...
                                name="keterangan"
                                id="keterangan"
                                placeholder="Contoh: Lantai 1 Rak X Nomor 11"
                                value={this.state.keterangan}
                                onChange={this.onChangeLokasi}
                              />
                              <FormText color="danger">
                                {this.state.keteranganHelp}
                              </FormText>
                            </FormGroup>
                          </ModalBody>
                          <ModalFooter>
            ...
            <ModalBody className="mx-4">
              ...
              <FormGroup>
                ...
                <Input
                  ...
                  name="editKeterangan"
                  id="editKeterangan"
                  placeholder="Contoh: Lantai 1 Rak X Nomor 1"
