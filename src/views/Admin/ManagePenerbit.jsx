    ...
    axios
      ...
      .then((response) => {
        ...
        this.state.penerbits.map((value, key) => {
          return this.state.newPenerbits.push({
            no: key + 1,
  ...
  submitNow = (e) => {
    ...
    if (this.state.btn === "Tambah") {
      ...
      if (isValid === true) {
        ...
        axios
          .post("http://localhost:8080/api/v1/penerbit/add", penerbitDto, {
            headers: userHeader,
          })
          .then((response) => {
            this.setState({
    ...
    // jika button edit data
      ...
      if (isValid === true) {
        ...
        axios
          .put("http://localhost:8080/api/v1/penerbit/edit", penerbitDto, {
            headers: userHeader,
          })
          .then((response) => {
            this.setState({
  ...
  handleDelete = (id) => {
    ...
    MySwal.fire({
      ...
      if (willDelete.isConfirmed) {
        axios
          .delete("http://localhost:8080/api/v1/penerbit/delete/" + id, {
            headers: userHeader,
          })
          .then((response) => {
            this.setState({
