                ...
                <Card className="card-user">
                    ...
                    <CardBody>
                        <div className="author mb-4">
                            ...
                            <p className="description">Admin<br></br>
                                ...
                                <Modal isOpen={editModal} toggle={toggleEdit} className="modal-lg">
                                    ...
                                    style={{backgroundImage: "linear-gradient(to left, #44a08d, #093637)",
                    ...
                    <CardBody>
                        ...
                        <Col md="4" xs="5">
                            <div className="icon-big text-center icon-warning" >
                                <i className="fas fa-venus-mars" style={{color:"#44a08d"}}/>
                            </div>
                        </Col>
                        <Col md="8" xs="7">
                            <div>
            ...
            <Col xs="12" sm="6">
                <Card className="card-stats">
                    <CardBody>
                        ...
                        <Col md="4" xs="5">
                            <div className="icon-big text-center icon-warning" >
                                <i className="fas fa-calendar-alt" style={{color:"#44a08d"}}/>
                            </div>
                        </Col>
                        <Col md="8" xs="7">
                            <div>
                                <p className="card-category">TTL</p>
                                <CardTitle tag="h5">{detailUser.tempatLahir + ", " + handleTgl(detailUser.tanggalLahir)}</CardTitle>
                                <p />
                            </div>
                        </Col>
                        </Row>
