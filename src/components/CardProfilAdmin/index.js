...
const CardProfilAdmin = (props) => {
  const { foto, nama, role, saldo, donasi, denda } = props;
    ...
    const [edEmail, setEdEmail] = useState("alfian@kreasitech.com")
    const [edEmailHelp, setEdEmailHelp] = useState("")
    const [edUsername, setEdUsername] = useState("alfian")
